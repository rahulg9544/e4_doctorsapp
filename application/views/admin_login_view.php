...
<div class="login-box">
  <div class="login-logo">
    <a href="index.html"><img src="<?php echo base_url(); ?>templateadmin/admin/dist/img/wing_logo.png" width="20%"></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo base_url(); ?>index.php/Admin_login/login_admin" method="post">
