 ...
 <div class="row">
              ...
              <div class="card-header border-0">
                <h2>Events</h2>
                  ...
                  <div class="card-body">
                    <input type="text" class="knob" value="60" id="evcount"  
                    data-skin="tron" data-thickness="0.2" data-width="200"
                           data-height="200" data-fgColor="#f56954">
              ...
              <div class="inner text-center">
                ...
                <h2 style="font-size: 1rem;">Event Notifications</h2>
              </div>
              <!-- <div class="icon">
                <i class="fas fa-shopping-cart"></i>
              </div> -->
              <a href="<?php echo base_url();?>index.php/Admin_event" class="small-box-footer">
                More info <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          ...
          <div class="col-12">
              ...
              <div class="inner text-center">
                ...
                <h2 style="font-size: 1rem;">Members List</h2>
              </div>
              <!-- <div class="icon">
                <i class="fas fa-shopping-cart"></i>
              </div> -->
              <a href="<?php echo base_url();?>index.php/Admin_members" class="small-box-footer">
                More info <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
              ...
              <div class="card-header border-0">
                <h2>Members</h2>
                  ...
                  <div class="card-body">
                    <input type="text" class="knob" value="60" id="membcount" data-skin="tron" data-thickness="0.2" data-width="200"
                           data-height="200" data-fgColor="#f56954">
...
function geteventno(){
    ...
    $.ajax({
                ...
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_home/geteventCount');?>/",
                data: '', // serializes the form's elements.
               success: function(data){
                //alert("hi");
                var result = JSON.parse(data);
                    $('#evcount').val(result.eventcount);
                    $('#membcount').val(result.membercount);
                }
             });
}
