            ...
            <div class="card-body">
              ...
              <div class="col-6">
                 ...
                 <div class="form-group">
                    ...
                    <textarea class="textarea" placeholder="About Us content"
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="link" class="form-control" id="exampleInputEmail1" placeholder="Email">
                  </div>

              </div>

              <div class="col-12 text-right"><button type="button" class="btn btn-lg btn-primary">Save</button></div>
