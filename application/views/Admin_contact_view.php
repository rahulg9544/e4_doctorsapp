          ...
          <div class="modal-content">
            ...
            <div class="row">
              <div class="col-md-6">
                 <div class="form-group">
                  <input type="hidden" name="editnm" id="editid">
                    <label for="regno">Primary Email</label>
                    <input type="text" name="mail1nm" class="form-control" id="mail1id" >
                  </div>
              </div>
              <div class="col-md-6">
                
                 <div class="form-group">
                    <label for="fname">Alternate Email</label>
                    <input type="text" class="form-control" id="mail2id" name="mail2nm" >
                  </div>
              ...
              <div class="col-md-6">
                 ...
                 <div class="form-group">
                    <label for="fname">Primary Number</label>
                    <input type="text" class="form-control" id="phone1id" name="phone1nm" >
                  </div>
              ...
              <div class="col-md-6">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="phone2id" name="phone2nm" >
                  </div>
              ...
              <div class="col-md-6">
                 ...
                 <div class="form-group">
                    <label for="fname">Locationsrc</label>
                    <input type="text" class="form-control" id="locationid" name="locationnm" >
                  </div>
              ...
              <div class="col-md-6">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="addrid" name="addrnm" >
                  </div>
