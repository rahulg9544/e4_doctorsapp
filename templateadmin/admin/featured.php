      ...
      <div class="row">
        ...
        <!-- /.col -->
                        ...
                        <div class="col-md-12">
                          <div class="card">
                            <div class="card-header">
                              <h3 class="text-center">Algoritham management</h3>
                            </div>
                            <div class="card-body text-center">
                              <div class="row mb-4">
                              <div class="col-sm-6">
                                <h5>No of Purchases <span class="badge" style="font-size: 2rem;"><input type="text" value="20" ></span> </h5>
                              </div>

                              <div class="col-sm-6">
                               <h5>No of Wishlist  <span class="badge" style="font-size: 2rem;"><input type="text" value="20" ></span> </h5>
                              </div>
                            </div>
                            ...
                            <div class="row text-center">
                              <div class="col-sm-6">
                                <h5>No of Views  <span class="badge" style="font-size: 2rem;"><input type="text" value="20" ></span> </h5>
                              </div>

                              <div class="col-sm-6">
                               <h5>No of Add to cart  <span class="badge" style="font-size: 2rem;"><input type="text" value="20" ></span> </h5>
                              </div>
                            </div>
