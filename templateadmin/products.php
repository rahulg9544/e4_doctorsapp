							...
							<div class="col-md-3 product-agileinfo-grid">
		                           ...
		                           <div class="brand-w3l">
									...
									<ul>
										...
										<li><a href="#">Lilliput</a></li>
										<li><a href="#">Cucumber</a></li>
										<li><a href="#">Nino Bambino</a></li>
										<li><a href="#">Nike</a></li>
								...
								<!-- 	<input type="text" id="demo_1" name="rangePrimary" value="" />
								...
								<div class="top-rates">
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="single.php"><img class="img-responsive " src="images/i1.jpg" alt=""></a>	
										</div>
