          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="offset-8 col-4">
                  ...
                  <button type="button" class="btn btn-success text-left" data-toggle="modal" data-target="#modal-xl">Create discount codes</button>
              ...
              <div class="col-12">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Validity">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Discount Type</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Discount Type">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Maximum Usage</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Maximum Usage">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Discount Code</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Discount Code">
                  </div>
