        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <a class="btn btn-app float-sm-right"  data-toggle="modal" data-target="#modal-xl">
                  <i class="fas fa-user-plus"></i> Add Kid
                </a>
            ...
            <div class="card-header">
              ...
              <div class="col-4">
                 <div class="form-group">
                    <label for="exampleInputEmail1">Kids Name</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Kids Name">
                  </div>
              </div>
          ...
          <div class="modal-content">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Building Number">
                  </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                 ...
                 <div class="form-group">
                    <label for="exampleInputEmail1">Flat/Apartment Number</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Block Number">
                  </div>
            ...
            <div class="row">
             ...
             <div class="row">
              ...
              <!-- <div class="col-md-6">
                 ...
                 <div class="form-group">
                    <label for="exampleInputEmail1">Sub-package Name</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Sub-package Name">
                  </div>
