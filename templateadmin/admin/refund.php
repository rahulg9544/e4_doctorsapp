              ...
              <div class="col-12">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="Date" class="form-control" id="exampleInputEmail1" placeholder="Product code">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Order Id</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Order Id">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Mobile Number">
                  </div>
