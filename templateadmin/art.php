...
<button type="button" id="myButton" class="btn btn-danger next-step btn-theme btn-ord">Order History</button>
	...
	<div class="single category">
        ...
        <option>4</option> -->
            ...
            <li><a href="art.php" title="">Article & Blog  <span class="pull-right"><i class="fas fa-angle-double-right"></i></span></a></li>
            <li><a href="" title="">E-learning</a></li>
          
            <li><a href="account.php" title="">Email Photo</a></li>
...
<h1 class="text-center pb-1">Article & Blog</h1>
 <div class="row">
		<div class="well">
